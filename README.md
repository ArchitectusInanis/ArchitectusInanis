...
I don't use this archived GitHub profile anymore, there are still some CI/CD automations running which is fascinating, the code most be stable enough to last years. One of the organizations that I created ShadowGuardAI used CI/CD and AI mass-produce defensive AI tools.
